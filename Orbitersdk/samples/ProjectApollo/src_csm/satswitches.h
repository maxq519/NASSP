...
public:
	...
	double ExperimentCovers1IndicatorDelay = -1.0; //4 Sec delay
	double ExperimentCovers2IndicatorDelay = -1.0; //4 Sec delay
	double ExperimentCovers3IndicatorDelay = -1.0; //4 Sec delay
};
