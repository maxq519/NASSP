...
void HF_Antenna_1::DefineAnimations(UINT idx)
{
	...
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp0(idx, DipoleAntenna1Grp0, 1, _V(-0.526243, 0.486454, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp1(idx, DipoleAntenna1Grp1, 1, _V(-1.052490, 0.972907, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp2(idx, DipoleAntenna1Grp2, 1, _V(-1.578730, 1.459360, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp3(idx, DipoleAntenna1Grp3, 1, _V(-2.104970, 1.945810, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp4(idx, DipoleAntenna1Grp4, 1, _V(-2.631201, 2.432260, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp5(idx, DipoleAntenna1Grp5, 1, _V(-3.157450, 2.918710, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp6(idx, DipoleAntenna1Grp6, 1, _V(-3.683690, 3.405160, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp7(idx, DipoleAntenna1Grp7, 1, _V(-4.209930, 3.891610, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp8(idx, DipoleAntenna1Grp8, 1, _V(-4.736170, 4.378060, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp9(idx, DipoleAntenna1Grp9, 1, _V(-5.262410, 4.864510, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp10(idx, DipoleAntenna1Grp10, 1, _V(-5.78865, 5.35096, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp11(idx, DipoleAntenna1Grp11, 1, _V(-6.31489, 5.83741, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp12(idx, DipoleAntenna1Grp12, 1, _V(-6.84113, 6.32386, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp13(idx, DipoleAntenna1Grp13, 1, _V(-7.36737, 6.81031, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna1Grp14(idx, DipoleAntenna1Grp14, 1, _V(-7.89361, 7.29676, 0));
...
void HF_Antenna_2::DefineAnimations(UINT idx)
{
	...
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp0(idx, DipoleAntenna2Grp0, 1, _V(0.526243, -0.486454, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp1(idx, DipoleAntenna2Grp1, 1, _V(1.052490, -0.972907, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp2(idx, DipoleAntenna2Grp2, 1, _V(1.578730, -1.459360, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp3(idx, DipoleAntenna2Grp3, 1, _V(2.104970, -1.945810, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp4(idx, DipoleAntenna2Grp4, 1, _V(2.631201, -2.432260, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp5(idx, DipoleAntenna2Grp5, 1, _V(3.157450, -2.918710, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp6(idx, DipoleAntenna2Grp6, 1, _V(3.683690, -3.405160, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp7(idx, DipoleAntenna2Grp7, 1, _V(4.209930, -3.891610, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp8(idx, DipoleAntenna2Grp8, 1, _V(4.736170, -4.378060, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp9(idx, DipoleAntenna2Grp9, 1, _V(5.262410, -4.864510, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp10(idx, DipoleAntenna2Grp10, 1, _V(5.78865, -5.35096, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp11(idx, DipoleAntenna2Grp11, 1, _V(6.31489, -5.83741, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp12(idx, DipoleAntenna2Grp12, 1, _V(6.84113, -6.32386, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp13(idx, DipoleAntenna2Grp13, 1, _V(7.36737, -6.81031, 0));
	static MGROUP_TRANSLATE mgs_DipoleAntenna2Grp14(idx, DipoleAntenna2Grp14, 1, _V(7.89361, -7.29676, 0));
